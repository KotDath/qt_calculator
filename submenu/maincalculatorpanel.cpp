...
MainCalculatorPanel::MainCalculatorPanel(QWidget *parent) : QWidget(parent), unaryButtons(new UnaryOperationButton* [2]), binaryButtons(new BinaryOperationButton* [4]) {
