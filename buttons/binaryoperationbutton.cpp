...
BinaryOperationButton::BinaryOperationButton(std::function<double(double, double)> op, char name, QWidget *parent) : QPushButton(parent), unaryOperation(op), opName(name) {
